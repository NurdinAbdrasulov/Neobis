...
public class ManufacturersController {
    ...
    @PostMapping("/add")
    public String addManufacturer(@RequestBody ManufacturerModel manufacturerModel){
    ...
    public String update(@PathVariable int id, @RequestBody ManufacturerModel manufacturerModel){
