...
create table employees (id integer not null auto_increment, address varchar(255), fio varchar(255), gender varchar(255), login varchar(255), password varchar(255), phone_number varchar(255), position varchar(255), role varchar(255), primary key (id))  ;
create table manufacturers (id integer not null auto_increment, address varchar(255), country varchar(255), phone_number varchar(255), brand_id integer, primary key (id))  ;
create table ordered_cars (id integer not null auto_increment, order_date datetime(6), count_of_cars integer not null, status varchar(255), primary key (id))  ;
create table ordered_cars_cars (ordered_cars_id integer not null, cars_id integer not null)  ;
create table sales (id integer not null auto_increment, count_of_cars integer not null, paid double precision not null, payment_amount double precision not null, registration_date datetime(6), status varchar(255), car_id integer, clients_id integer, employee_id integer, primary key (id))  ;
